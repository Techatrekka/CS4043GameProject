...
function scene:hide( event )
    ...
    display.remove(Path1)
    display.remove(Path2)
    display.remove(Path3)
    display.remove(Path4)
    display.remove(Path5)
    display.remove(Path6)
    display.remove(Path7)
    display.remove(Path8)
    display.remove(Path9)
    display.remove(Path10)
    display.remove(redZone1)
    display.remove(redZone2)
    display.remove(redZone3)
    display.remove(redZone4)
    display.remove(redZone5)
    display.remove(redZone6)
    display.remove(redZone7)
    display.remove(redZone8)
    display.remove(redZone9)
    display.remove(greenZone)
    display.remove(greenZone1)
    display.remove(background)
    display.remove(GrassyArea)
    physics.pause()
