...
physics.addBody( Sprite, "dynamic", {friction = 0.0, bounce = 0.0 } )
...
local function walkPerson(event)
  ...
  elseif (event.keyName == 'a' or event.keyName == 'left' and event.phase == 'down') then
    Sprite:setLinearVelocity(-200, 0)
  else
...
local leftWall = display.newRect(80, 300, 2, display.contentHeight + 250)
